...
export default function Hero() {
  ...
  return (
    <main>
      ...
      {/* Statistics Section */}
      <section
        className="bg-[var(--var-red-col)] text-white px-4 py-8"
        aria-label="Company statistics"
      >
        <div className="max-w-full mx-auto grid grid-cols-2 sm:grid-cols-4 gap-y-4 text-center">
          {wel.map((item, index) => (
            <article
            ...
            >
              <span className="text-xl sm:text-2xl font-extrabold flex items-center gap-1">
