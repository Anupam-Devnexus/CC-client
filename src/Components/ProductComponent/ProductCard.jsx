        ...
        <div className="w-full max-w-xs bg-[var(--var-red-col)]/10 shadow-xl rounded-2xl overflow-hidden flex flex-col  hover:shadow-2xl transition-all duration-300">
            ...
            <div className="flex flex-col gap-3 px-4 py-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        className="wishlist-button border border-gray-300 hover:border-[var(--var-red-col)] px-3 py-2 rounded-lg cursor-pointer flex items-center justify-center shadow-sm transition-all duration-300 bg-white group"
                        onClick={(e) => {
                            e.stopPropagation();
                            toggleWishList(item);
                        }}
                    ...
                    >
                        {isWished ? (
                            <BsBagHeartFill className="text-[var(--var-red-col)] transition-transform duration-300 group-hover:scale-110" size={22} />
                        ) : (
