...
export default function AboutUsCarousel() {
  ...
  return (
    <section className="w-full max-w-5xl mx-auto" aria-label="Company Media Gallery">
      {/* Main Carousel */}
      <div className="relative w-full flex items-center justify-between overflow-hidden px-2 gap-2 mt-2 mb-4">
        <button
          onClick={prevSlide}
        ...
        <div
          className="w-full h-30 sm:h-72 md:h-96 lg:h-[28rem] xl:h-[32rem] overflow-hidden relative rounded-md"
          aria-live="polite"
        >
          <div
            key={current}
          ...
          >
            <img
              ...
              className="sm:w-3/4 sm:h-3/4 h-full w-full  object-fill"
              loading="lazy"
            />
          </div>
        </div>
