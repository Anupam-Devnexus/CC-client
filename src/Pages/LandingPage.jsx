...
export default function LandingPage() {
    ...
    const combinedBricks = [
        ...
        },
        {
            ...
            link: '/products/residential-tiles',
    ...
    return (
        <main className="w-full">
            ...
            {/* About Section */}
            <section className="bg-[var(--var-red-col)] px-6 py-12 text-white text-center">
                <div className="max-w-6xl mx-auto">
                    ...
                    <p className="text-base text-left sm:text-lg text-white/90 mb-8 px-2 sm:px-8">
                        Cervino Ceramix is emerging as a premier name in India’s building materials industry, delivering superior-quality bricks designed for modern home construction. Known for its unwavering commitment to excellence, innovation, and customer satisfaction, Cervino Ceramix leverages cutting-edge manufacturing technology to produce bricks that excel in strength, durability, and aesthetic appeal.
                        <br /> <br />
                        With advanced production facilities and stringent quality control measures, every brick from Cervino Ceramix is crafted to exceed industry standards. This dedication to quality makes them the trusted choice of architects, builders, and homeowners across the nation. With Cervino Ceramix, you’re not just building structures—you’re building with confidence and quality that stands the test of time.
                    </p>

                    <div className="bg-white text-gray-800 rounded-xl shadow-lg hover:shadow-2xl px-6 sm:px-12 py-8">
                        <h3 className="text-xl text-left sm:text-2xl font-semibold text-[var(--var-red-col)] mb-4">
                            Our Ethics
                        </h3>
                        <ul className="list-disc list-inside text-left text-base sm:text-lg space-y-2">
            ...
            >
                ...
                <div className="flex justify-center mb-6 px-4">
                    <img
                        src="https://images.pexels.com/photos/2090649/pexels-photo-2090649.jpeg"
                        alt="Featured project showcasing premium brick construction"
                        className="h-72 sm:h-96 w-full max-w-4xl object-cover rounded shadow hover:scale-105 transition-transform duration-500 ease-in-out"
                        loading="lazy"
                    />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 p-4 items-start">
                <div className="w-full h-full">
                    <img
                        src="https://res.cloudinary.com/dy6a2ncau/image/upload/v1747814714/WhatsApp_Image_2025-05-21_at_1.02.22_AM_qzuj52.jpg"
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    {FindusLink.map((e, index) => (
                        <a
                            ...
                            className="flex items-center justify-center w-14 h-14 rounded-full bg-[var(--var-gray-col)] hover:bg-[var(--var-red-col)] hover:scale-105 transition-transform duration-2000  shadow-[var(--var-red-col)]"
                        >
                            <img src={e.image} alt={e.alt} className="w-7 h-7" />
                        </a>
