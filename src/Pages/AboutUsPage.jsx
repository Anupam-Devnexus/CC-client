        ...
        <section aria-labelledby="about-us-heading ">
            ...
            >
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://images.pexels.com/photos/273209/pexels-photo-273209.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`,
                    }}
                    role="img"
                    aria-label="Brick wall background"
                />
            ...
            >
                <div className="grid grid-cols-1 sm:grid-cols-2 sm:gap-2 items-center max-w-4xl w-full">
                    {/* Image + Label */}
                    <div className="flex flex-col justify-center text-center items-center sm:items-start gap-5">
                        <img
                        ...
                        <span
                            ...
                            className="font-semibold text-center text-lg text-[var(--var-red-col)]"
                        >
                           Years of Experience
                        </span>
                    </div>
            ...
            <div className="flex flex-col items-center mb-1">
                <span className="text-[var(--var-red-col)] mt-4 sm:text-3xl text-2xl font-semibold">Media Coverage & Partnership</span>
                <AboutUsCarausal />
            </div>
